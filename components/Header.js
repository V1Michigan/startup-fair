...
const Header = () => {
  ...
  return (
    <div className="h-screen bg-gray-800 bg-topography-white text-center flex flex-col justify-center">
      <div className="p-8">
        {/* <h2 className="md:text-4xl text-lg mt-1 tracking-tight text-yellow-400 break-words syncopate">
          University of Michigan
        </h2> */}
        <h1 className="md:text-7xl text-3xl tracking-tight font-bold text-white leading-none break-words syncopate">
          V1 STARTUP FAIR 🚀
        </h1>
        <h2 className="md:text-xl text-md mt-1 tracking-tight text-yellow-400 break-words syncopate">
          COMING FALL 2022
        </h2>
      </div>
