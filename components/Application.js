...
export default function Application() {
  ...
  return (
    <section className="max-w-screen mt-auto p-4">
      <div className="m-4">
      ...
      <div className="max-w-xl mx-auto text-center">
        ...
        <div className="flex flex-row flex-wrap gap-2 justify-center md:flex-no-wrap px-10">
          <input
            className={`text-white text-sm md:text-lg outline-none bg-transparent border-2 border-yellow-400 py-3 rounded-md shadow-sm px-3 leading-tight focus:outline-none ${
          ...
          />
          <button
            className={`text-base text-sm md:text-lg font-bold outline-none text-black py-2 px-5 rounded-md bg-yellow-400 ${
              submitted ? "opacity-50 cursor-not-allowed" : "hover:opacity-75"
            } `}
            onClick={submitEmail}
            disabled={submitted}
          >
        ...
        <p className="italic text-white mt-4 text-sm md:text-lg">
